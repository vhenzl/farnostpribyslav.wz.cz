...
export default async function Page(): Promise<JSX.Element> {
  ...
  return (
    <section className="flex items-center justify-center min-h-[60vh] py-8 flex-col text-stone-800">
      <PageTitle className="sm:text-5xl text-center mb-4">Farnost Přibyslav</PageTitle>
      ...
      <p className="mb-2 text-center">Rychlé odkazy na zprávy z jednotlivých let:</p>
